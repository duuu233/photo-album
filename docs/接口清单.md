...
| 投屏记录 | 编辑投屏记录 | `POST /Client/UserProduct/editUserProductImgRecord` | ✅ | `editUserProductImgRecord` | 设备图传成功后置 `deviceUploadState:1`，body 传 `upirId/taskId/deviceUploadState` |
...
| 我的图库 | 列表 | `GET /Client/UserProduct/getUserProductImgList` | ✅ | `getUserProductImgList` | - |
| 我的图库 | 删除 | `POST /Client/UserProduct/delUserProductImg` | ✅ | `delUserProductImg` | id=uProductImgId，支持多选 |
| 投屏管理 | 投屏记录图片列表（成功/失败） | `GET /Client/UserProduct/getUserProductImgRecordList` | ✅ | `getUserProductImgRecordList` | **Swagger 新增** |
